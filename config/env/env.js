const env = {
    ...
    dbNeo4jHost: process.env.DB_HOST || 'localhost',
    dbNeo4jPort: process.env.DB_PORT || '',
    dbNeo4jUser: process.env.DB_USER || '',
    dbNeo4jPassword: process.env.DB_PASSWORD || '',
    dbNeo4jDatabase: process.env.DB_DATABASE || 'proj-ind',
